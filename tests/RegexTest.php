 ...
 * @version		1.0
 * @filesource 	./tests/RegexTest.php
 */
...
/**
 * Jaeger - Regex object Unit Tests
 *
 * Contains all the unit tests for the \JaegerApp\Regex object
 *
...
class RegexTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertClassHasAttribute('instance', '\JaegerApp\Regex');
